...
@C:\Downloads\05_Oracle\app\oracle\product\11.2.0\server\rdbms\admin\dbmsobtk.sql
@C:\Downloads\05_Oracle\app\oracle\product\11.2.0\server\rdbms\admin\prvtobtk.plb
/*
...
--==>> Grant을(를) 성공했습니다.
--SCOTT이 DBMS_OBFUSCATION_TOOLKIT 패키지의
